...
<div class="container" id="womenGallary">
  ...
  <div class="row" style="width: 80%; margin-left: 10%; margin-right: 5%;">
    <div class="col-sm-4" id="w_1" href="register.html">
...
<div class="container">
  ...
  <div class="row" style="width: 80%; margin-left: 10%; margin-right: 5%;">
    <div class="col-sm-4" id="w_1">
       <img src="image/img6.jpg" style="width: 100%;height:350px;">
        <img src="image/img2.jpg" style="width: 100%;height:350px;" class="img-front">
          </div>
    <div class="col-sm-4" id="w_1">
       <img src="image/img2.jpg" style="width: 100%;height: 350px;">
        <img src="image/img6.jpg" style="width: 100%;height:350px;" class="img-front">

    </div>
      <div class="col-sm-4" id="w_1">
       <img src="image/img3.jpg" style="width: 100%;height: 350px;">
       <img src="image/img4.jpg" style="width: 100%;height:350px;" class="img-front">
         </div>
          </div>
         <br>
         <div class="row" style="width: 80%; margin-left: 10%;">
    ...
    <div class="col-sm-4" id="w_1">
       <img src="image/img2.jpg" style="width: 100%;height: 350px;">
       <img src="image/img3.jpg" style="width: 100%;height:350px;" class="img-front">
    </div>
      <div class="col-sm-4" id="w_1">
       <img src="image/img3.jpg" style="width: 100%;height: 350px;">
       <img src="image/img1.jpg" style="width: 100%;height:350px;" class="img-front">
    </div>
...
<div class="container">
    ...
    <p style="text-align: center;"> cillum dolore eu fugiat nulla pariatur.<br> Excepteur sint occaecat cupidatat non</p>
  <div class="row" style="margin-left: 10%; margin-right: 5%;">
  <div class="col-sm-4" ><div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
      <img src="image/img1.jpg" alt="Avatar" style="width:100%;height:300px;">
    </div>
    <div class="flip-card-back">
      <h3>White Shirt</h3> 
      <p class="pDesc">This summer season we introduce this<br>
  100% cotton base shirt</p>
 <p class="addToCart" style="border:solid 2px white; width:60%;margin-left: 60px;padding: 10px;border-radius: 20px">Add to Cart <i class="fas fa-shopping-cart" style="font-size: 15px"></i></p>
    </div>
  </div>
</div></div>
  <div class="col-sm-4"><div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
      <img src="image/img2.jpg" alt="Avatar" style="width:100%;height:300px;">
    </div>
    <div class="flip-card-back">
     <h3>White Shirt</h3> 
      <p class="pDesc">This summer season we introduce this<br>
